...
const GUIDE_SKINS = [
  {
    ...
    variants: {
      ...
      orange_t3: V(
        'Orange Sun T3',
        [
          39, 42, 82, 166, 181, 213, 235, 237, 343, 369, 463, 486, 493, 496, 502, 509, 625, 638,
          737, 742, 810, 853, 872,
        ],
      ),
      ...
      red_t3: V(
        'Red Sun T3',
        [
          4, 59, 94, 149, 162, 177, 264, 326, 343, 352, 358, 372, 388, 454, 475, 527, 580, 755, 852,
          988,
        ],
      ),
      red_t4: V(
        'Red Sun T4',
        [
          14, 38, 41, 103, 122, 184, 186, 256, 274, 350, 392, 431, 501, 544, 452, 473, 564, 618,
          628, 644, 670, 691, 709, 757, 886, 947, 963,
        ],
      ),
      ...
      yellow_t3: V(
        'Yellow Sun T3',
        [19, 53, 111, 168, 259, 308, 332, 375, 430, 482, 503, 674, 680, 820],
      ),
      yellow_t4: V(
        'Yellow Sun T4',
        [16, 44, 48, 66, 69, 134, 273, 316, 347, 356, 365, 406, 465, 557, 701, 792, 808, 967, 970],
      ),
      white_clouds: V(
        'White Clouds',
        [
  ...
  },
  {
    ...
    tiers: [
      ...
      },
      {
        ...
        label: 'Fade Gem T2',
        seeds: [
          2, 5, 13, 19, 30, 33, 36, 51, 61, 62, 66, 67, 91, 107, 115, 120, 123, 127, 138, 147, 158,
          163, 165, 170, 174, 176, 190, 206, 213, 219, 224, 232, 239, 262, 272, 283, 294, 300,
        ],
      },
      {
        tier: 4,
        label: 'Fade Gem T3',
        seeds: [
          9, 18, 21, 23, 31, 34, 35, 64, 71, 72, 86, 92, 99, 104, 105, 136, 137, 151, 160, 161, 189,
          216, 217, 221, 235, 236, 242, 244, 249, 254, 255, 287, 290, 291, 295,
        ],
      },
    ],
    variants: {

...
const STRINGS: Record<string, Entry> = {
  ...
  'filter.show': { en: 'Show', 'pt-BR': 'Exibir' },
  'filter.show.all': { en: 'All', 'pt-BR': 'Todos' },
  'filter.show.new': { en: 'New only', 'pt-BR': 'Só novos' },
  ...
  // ── Scan memory: diff badge / snapshot restore / CSV export (v0.10) ──
  'badge.new': { en: 'NEW', 'pt-BR': 'NOVO' },
  'snap.offer': {
    en: 'Last scan saved {ago} ago — {n} results.',
    'pt-BR': 'Último scan salvo há {ago} — {n} resultados.',
  },
  'snap.restore': { en: 'Restore', 'pt-BR': 'Restaurar' },
  'snap.restored': {
    en: 'Restored {n} results from the last scan ({ago} ago).',
    'pt-BR': '{n} resultados restaurados do último scan (há {ago}).',
  },
  'export.csv': { en: 'Export results as CSV', 'pt-BR': 'Exportar resultados em CSV' },
  'export.done': { en: 'Exported {n} rows.', 'pt-BR': '{n} linhas exportadas.' },
  'export.empty': { en: 'Nothing to export yet.', 'pt-BR': 'Nada para exportar ainda.' },
